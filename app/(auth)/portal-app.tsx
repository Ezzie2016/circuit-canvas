      ...
      <div className="flex min-h-[360px] flex-col justify-between rounded-lg bg-[#1d6d58] p-8 text-white shadow-sm lg:p-10">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden items-center gap-2 text-sm text-white/80 sm:flex">
            <Link className="rounded-xl border border-white/20 px-3 py-1" href="/student">
              Student
            </Link>
            <Link className="rounded-xl border border-white/20 px-3 py-1" href="/teacher">
              Teacher
            </Link>
            <Link className="rounded-xl border border-white/20 px-3 py-1" href="/admin">
              Admin
            </Link>
          </div>
        </nav>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                {!isRead ? (
                  <span className="rounded-xl bg-[#1d6d58] px-2 py-1 text-xs font-semibold text-white">
                    New
                  </span>
                ) : null}
              </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="rounded-xl bg-[#e1f1ea] px-3 py-1 text-sm font-semibold text-[#1d6d58]">
        ...
        {events.length ? (
          events.slice(0, 6).map((event) => (
            ...
            >
              ...
              <span
                className={`h-fit rounded-xl px-3 py-1 text-xs font-semibold ${
...
function ProgressMetric({
  ...
  return (
    <div>
      ...
      <div className="h-3 overflow-hidden rounded-xl bg-[#eef1e9]">
        <div
          className={`h-full rounded-xl ${toneClass}`}
  ...
  return (
    <article className="rounded-md border border-[#d8ddd2] p-4">
      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
        ...
        <span className="rounded-xl bg-[#eef1e9] px-3 py-1 text-xs font-semibold text-[#46534b]">
      ...
      <div className="mt-4 h-2 overflow-hidden rounded-xl bg-[#eef1e9]">
        <div
          className="h-full rounded-xl bg-[#1d6d58]"
  ...
  return (
    <div className="rounded-md border border-[#d8ddd2] p-4">
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="rounded-xl bg-[#fff2d7] px-3 py-1 text-xs font-semibold text-[#7a4c00]">
  ...
  return (
    <div className="rounded-md border border-[#d8ddd2] p-4">
      <div className="flex flex-col justify-between gap-3 sm:flex-row">
        ...
        <span className="h-fit rounded-xl bg-[#e1f1ea] px-3 py-1 text-xs font-semibold text-[#1d6d58]">
          {submission.status}
        </span>
      </div>
