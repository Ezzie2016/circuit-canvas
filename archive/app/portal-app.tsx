      ...
      <div className="flex items-center">
        <div className="w-full rounded-lg border border-[#d8ddd2] bg-white p-5 shadow-sm sm:p-7">
          ...
          <form className="space-y-4" onSubmit={onAuth}>
            ...
            />
            <button
              className="h-12 w-full rounded-md bg-[#153f3a] px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#0f302c]"
              type="submit"
            >
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                {!isRead ? (
                  <span className="rounded-full bg-[#153f3a] px-2 py-1 text-xs font-semibold text-white">
                    New
                  </span>
                ) : null}
              </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="rounded-full bg-[#e1f1ea] px-3 py-1 text-sm font-semibold text-[#153f3a]">
    ...
    <Panel title="User management" eyebrow={`${users.length} accounts`}>
      <form className="grid gap-3 lg:grid-cols-[1fr_1fr_140px_auto]" onSubmit={handleSubmit}>
        ...
        <label className="block">
          ...
          <select
            className="h-11 w-full rounded-md border border-[#cbd3c5] bg-white px-3 text-sm outline-none transition focus:border-[#153f3a] focus:ring-2 focus:ring-[#153f3a]/15"
            name="role"
          >
            {roles.map((role) => (
  ...
  return (
    <article className="rounded-md border border-[#d8ddd2] p-4">
      ...
      <div className="mt-4 h-2 overflow-hidden rounded-full bg-[#eef1e9]">
        <div
          className="h-full rounded-full bg-[#153f3a]"
...
function MiniStat({ label, value }: { label: string; value: number }) {
  return (
    <div className="rounded-md bg-[#f6f7f3] p-3">
      ...
      <strong className="mt-1 block text-xl font-semibold text-[#153f3a]">
        {value}
      </strong>
    </div>
  );
    ...
    <Panel title="Add course material" eyebrow="Resource library">
      <form className="space-y-3" onSubmit={handleSubmit}>
        ...
        <label className="block">
          ...
          <input
            className="w-full rounded-md border border-[#cbd3c5] bg-white px-3 py-2 text-sm file:mr-3 file:rounded file:border-0 file:bg-[#eef1e9] file:px-3 file:py-2 file:text-sm file:font-semibold file:text-[#153f3a]"
            name="attachment"
            type="file"
          />
        </label>
            ...
            return (
              ...
              >
                <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                  ...
                  <a
                    className="inline-flex h-10 items-center justify-center rounded-md bg-[#153f3a] px-4 text-sm font-semibold text-white transition hover:bg-[#0f302c]"
                    href={session.link}
                    rel="noreferrer"
                    target="_blank"
                  >
            ...
            >
              <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    className="h-10 rounded-md bg-[#153f3a] px-3 text-sm font-semibold text-white transition hover:bg-[#0f302c]"
                    onClick={() =>
  ...
  return (
    <div className="rounded-md border border-[#d8ddd2] p-4">
      <div className="flex flex-col justify-between gap-3 sm:flex-row">
        ...
        <span className="h-fit rounded-full bg-[#e1f1ea] px-3 py-1 text-xs font-semibold text-[#153f3a]">
          {submission.status}
        </span>
      </div>
...
function Metric({
  ...
  return (
    ...
    >
      ...
      <strong className="mt-2 block text-4xl font-semibold text-[#153f3a]">
        {value}
        {suffix}
      </strong>
    </div>
...
function Field({
  ...
  return (
    <label className="block">
      ...
      <input
        className="h-11 w-full rounded-md border border-[#cbd3c5] bg-white px-3 text-sm outline-none transition placeholder:text-[#9aa49d] focus:border-[#153f3a] focus:ring-2 focus:ring-[#153f3a]/15"
...
function TextArea({
  ...
  return (
    <label className="block">
      ...
      <textarea
        className="min-h-24 w-full resize-y rounded-md border border-[#cbd3c5] bg-white px-3 py-2 text-sm outline-none transition placeholder:text-[#9aa49d] focus:border-[#153f3a] focus:ring-2 focus:ring-[#153f3a]/15"
        name={name}
        placeholder={placeholder}
      />
    </label>
...
function PrimaryButton({ children }: { children: React.ReactNode }) {
  return (
    <button
      className="h-11 rounded-md bg-[#153f3a] px-4 text-sm font-semibold text-white transition hover:bg-[#0f302c]"
      type="submit"
    >
      {children}
    </button>
